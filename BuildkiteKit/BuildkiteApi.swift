...
public class BuildkiteApi {
  ...
  public func getOrganizations(completion: (organizations: [Organization], body: NSData?, response: NSHTTPURLResponse?, error: BuildkiteApiError?) -> Void) {
    ...
    ArrayOfJSONDataForEndpoint(url) { json, data, response, error in
      ...
      if let error : BuildkiteApiError = error {
        ...
        completion(organizations: organizations, body: data, response: response, error: nil)
      }
    }
  }
  ...
  public func getProjects(account: String, completion: (projects: [Project], body: NSData?, response: NSHTTPURLResponse?, error: BuildkiteApiError?) -> Void) {
    ...
    ArrayOfJSONDataForEndpoint(url) { json, data, response, error in
      ...
      if let error : BuildkiteApiError = error {
        ...
        completion(projects: projects, body: data, response: response, error: nil)
      }
    }
  }
  ...
  public func getBuilds(completion: (builds: [Build], body: NSData?, response: NSHTTPURLResponse?, error: BuildkiteApiError?) -> Void) {
    ...
    ArrayOfJSONDataForEndpoint(url) { jsonArray, data, response, error in
      ...
      if let error : BuildkiteApiError = error {
        ...
        completion(builds: builds, body: data, response: response, error: nil)
      }
    }
  }
  ...
  public func getAgents(account: String, completion: (agents: [Agent], body: NSData?, response: NSHTTPURLResponse?, error: BuildkiteApiError?) -> Void) {
    ...
    ArrayOfJSONDataForEndpoint(url) { jsonArray, data, response, error in
      ...
      if let error : BuildkiteApiError = error {
        ...
        completion(agents: agents, body: data, response: response, error: nil)
      }
    }
  }
  ...
  func ArrayOfJSONDataForEndpoint(url: NSURL, completion: ([[String: AnyObject]]?, NSData?, NSHTTPURLResponse?, BuildkiteApiError?) -> Void) {
    let task = session.dataTaskWithURL(url) { data, response, error in
      if let theResponse : NSHTTPURLResponse = response as? NSHTTPURLResponse {
        ...
        completion(jsonArray, data, theResponse, error)
      }
    }
  ...
  func JSONDataForRequest(request: NSURLRequest, completion: ([String: AnyObject]?, NSData?, NSHTTPURLResponse?, BuildkiteApiError?) -> Void) {
  ...
  func JSONDataForEndpoint(url: NSURL, completion: ([String: AnyObject]?, NSData?, NSHTTPURLResponse?, BuildkiteApiError?) -> Void) {
    let task = session.dataTaskWithURL(url) { data, response, error in
      if let theResponse : NSHTTPURLResponse = response as? NSHTTPURLResponse {
        let code = theResponse.statusCode
        var error : BuildkiteApiError?
